...
<style>
body,h1,h2,h3,h4,h5,h6 {font-family: "Times New Roman", Georgia, Serif color;
              letter-spacing: 3px;}
.menu {display: none}
.bgimg { 
...
<header class="bgimg w3-display-container w3-grayscale-min" id="home">
  ...
  <div class="w3-display-middle w3-center">
    <span class="w3-text-white w3-hide-small" style="font-size:100px">TODAYONEGRAB<br>A taste you'll remember.</span>
...
<footer class="w3-center w3-black w3-padding-48 w3-xxlarge">
  <p>Powered by <a href="logo_display.html" title="W3.CSS" target="_blank" class="w3-hover-text-green">NARIKOOTAM</a></p>
</footer>
